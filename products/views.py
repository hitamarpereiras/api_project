...
class  ProdutoListView(generics.ListAPIView):
    ...
    filterset_fields = ['categoria', 'promocao']
    ...
    def get_queryset(self):
        ...
        if promocao is not None:
            promocao_bool = promocao.lower() == 'true'
            queryset = queryset.filter(promocao=promocao_bool)
    ...
    def list(self, request, *args, **kwargs):
        ...
        if not queryset.exists():
            ...
            if categoria:
                mensagem = f"Produto encontrado na categoria '{categoria}'."
            else:
            ...
            return Response(
                {
                    ...
                    "produto": ProdutoSerializer(product).data
                },
